<%@ Page Language="C#" AutoEventWireup="true" CodeFile="APUrunEkle.aspx.cs" Inherits="APUrunEkle" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .urunekletable tr:last-child td
        {
        ...
        <table align="center" style="width: 76%;" class="urunekletable">
            ...
            <tr>
                <td class="style1">
                    &nbsp;</td>
                <td class="style10">
                    <asp:Button ID="urunkaydet" runat="server" Text="Urun Kaydet" 
                        onclick="urunkaydet_Click" />
                </td>
                <td class="style4">
                    &nbsp;</td>
            </tr>
